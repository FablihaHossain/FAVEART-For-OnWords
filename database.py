...
class Database():
	...
	def insert_checkpoint(text_list, animation_list, color, geolocation, font):
		# Getting the next ID
		nextId = Database.next_id("Checkpoints")

		# Creating a new checkpoint
		newCheckpoint = Checkpoints(checkpoint_id = nextId, text = text_list, animations = animation_list, color = color, geolocation = geolocation, font = font)
